...
*/
  ...
  This demo is based on the GD32350R-EVAL board, it shows the I2C programming mode in master 
...
If transfer is sucessfully completed, LED1 and LED2 is light. 
  ...
  We shoud use the jumper to connect the PB6 and PB10. The PB7 and PB11 are connected as well.In 
additon, the capacitance C8 of I/O pin PB11 needs to be removed. 
