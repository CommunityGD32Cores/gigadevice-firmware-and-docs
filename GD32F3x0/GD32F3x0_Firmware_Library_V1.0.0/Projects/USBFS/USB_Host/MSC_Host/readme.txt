...
to use the USBFS host peripheral on the GD32F3X0 devices.
  ...
  Jump the JP13 to USART to show the print message through HyperTerminal.
Then open the HyperTerminal and connect the COM1 to the PC through the serial port line. 
