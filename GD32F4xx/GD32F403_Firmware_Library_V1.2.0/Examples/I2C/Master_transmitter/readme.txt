...
*/
  ...
  This shows the I2C programming mode in master transmitting mode.In this demo,
I2C0 is operated as the master transmitter, and the SCL line and SDA line of 
I2C0 interface are controled by the I/O pin PB6 and PB7 respectively.
