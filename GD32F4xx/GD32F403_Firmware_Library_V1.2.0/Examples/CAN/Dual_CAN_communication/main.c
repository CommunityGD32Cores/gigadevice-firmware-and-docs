...
int main(void)
{
    ...
    printf("\r\nGD32F403 dual CAN test, please press Wakeup key or Tamper key to start communication!\r\n");
    /* configure leds */
    led_config();
...
void can_config(can_parameter_struct can_parameter, can_filter_parameter_struct can_filter)
{
    ...
    can_parameter.prescaler = 14;
    /* 250KBps */
#elif CAN_BAUDRATE == 250
    can_parameter.prescaler = 28;
    /* 125KBps */
#elif CAN_BAUDRATE == 125
    can_parameter.prescaler = 56;
    /* 100KBps */
#elif  CAN_BAUDRATE == 100
    can_parameter.prescaler = 70;
    /* 50KBps */
#elif  CAN_BAUDRATE == 50
    can_parameter.prescaler = 140;
    /* 20KBps */
#elif  CAN_BAUDRATE == 20
    can_parameter.prescaler = 350;
#else
