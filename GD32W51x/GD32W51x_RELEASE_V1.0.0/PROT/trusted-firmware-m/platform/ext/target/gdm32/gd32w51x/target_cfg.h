...
/**
 * \brief This function configures the flash watermarks for bootstrapping NSPE
 *
 * \return  Returns error code.
 */
...
/**
 * \brief This function configures non-secure memory spaces
 *        in the target SRAM used by NSPE
 */
void sram_mpcbb_config(void);

/**
 * \brief This function configure non-secure GPIOs used by NSPE
 */
