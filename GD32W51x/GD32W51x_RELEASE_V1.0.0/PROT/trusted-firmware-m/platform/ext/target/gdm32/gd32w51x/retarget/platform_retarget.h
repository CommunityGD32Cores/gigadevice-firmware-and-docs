 ...
 * \brief This file defines all the peripheral base addresses for GDM32101 platform.
 */

#ifndef __GDM32101_RETARGET_H__
#define __GDM32101_RETARGET_H__
...
#define UART0_BASE_NS          USART0
#define UART1_BASE_NS          USART1
...
#define UART0_BASE_S           0x50013800
#define UART1_BASE_S           0x50004400
...
#define FLASH_INTERNAL_BASE_S                  0x0C000000
#define FLASH_INTERNAL_BASE_NS                 0x08000000
#define FLASH_INTERNAL_SIZE                    0x00200000  /* 2 MB */
#define FLASH_INTERNAL_SECTOR_SIZE             0x00001000  /* 4 KB */
#define FLASH_INTERNAL_PAGE_SIZE               0x00001000  /* 4 KB */
#define FLASH_INTERNAL_PROGRAM_UNIT            1         /* Minimum write size */

#define FLASH_EXTERNAL_BASE_S                  0x00000000  /* offset inside flash chip */
#define FLASH_EXTERNAL_BASE_NS                 0x00000000  /* offset inside flash chip */
#define FLASH_EXTERNAL_SIZE                    0x00200000  /* 2 MB */
#define FLASH_EXTERNAL_SECTOR_SIZE             0x00001000  /* 4 KB */
#define FLASH_EXTERNAL_PAGE_SIZE               0x00000100  /* 256B */
#define FLASH_EXTERNAL_PROGRAM_UNIT            1         /* Minimum write size */

#endif  /* __GDM32101_RETARGET_H__ */
