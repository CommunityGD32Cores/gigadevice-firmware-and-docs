...
// <e> FLASH (Flash Memory) [Driver_FLASH_INTERNAL]
// <i> Configuration settings for Driver_FLASH_INTERNAL in component ::Drivers:FLASH
#define   RTE_FLASH_INTERNAL                     1
// </e> FLASH (Flash Memory) [Driver_FLASH_INTERNAL]

// <e> FLASH (Flash Memory) [Driver_FLASH_EXTERNAL]
// <i> Configuration settings for Driver_FLASH_EXTERNAL in component ::Drivers:FLASH
#define   RTE_FLASH_EXTERNAL                     0
// </e> FLASH (Flash Memory) [Driver_FLASH_EXTERNAL]
