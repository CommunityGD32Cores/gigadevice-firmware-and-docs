...
#else
#ifdef GD_MODIFY_TAG
#define S_IMAGE_PRIMARY_PARTITION_OFFSET  (RE_IMAGE_0_OFFSET + RE_VTOR_ALIGNMENT)  //test
#else
...
#ifdef GD_MODIFY_TAG
/* just reserve 4KB for image header*/
#define BL2_TRAILER_SIZE     (0x1000)
#else
...
#define CMSE_VENEER_REGION_SIZE     (0x500)
...
/* Secure regions */
#ifdef GD_MODIFY_TAG
#define S_CODE_START    (S_ROM_ALIAS(RE_IMG_0_PROT_OFFSET + RE_VTOR_ALIGNMENT))
#else
...
#ifdef GD_MODIFY_TAG
#define S_DATA_START    (S_RAM_ALIAS(RE_PROT_DATA_START))
#else
...
/* Non-secure regions */
#ifdef GD_MODIFY_TAG
#define NS_CODE_START   (NS_ROM_ALIAS(RE_IMG_0_NSPE_OFFSET + RE_VTOR_ALIGNMENT))
#else
...
#ifdef GD_MODIFY_TAG
#define NS_DATA_START   (NS_RAM_ALIAS(RE_NSPE_DATA_START))
#else
...
#define NS_PARTITION_START \
            (NS_ROM_ALIAS(RE_IMG_0_NSPE_OFFSET + RE_VTOR_ALIGNMENT))
#else
#define NS_PARTITION_START \
 ...
 */
#ifdef GD_MODIFY_TAG
#define BOOT_TFM_SHARED_DATA_BASE (RE_SRAM_BASE_S + RE_SHARED_DATA_START)
#else
