...
#define DUPLICATED_OCTET_PATCH    0
...
typedef struct
{
    unsigned char channel_locked;
    unsigned char cur_channel;
    unsigned char lock_channel;
    unsigned short lock_length;
    unsigned short wlan_seq_num;
    unsigned short last_sta_seq;
    unsigned short last_rx_len;
    unsigned char sta_seq_inited;
    unsigned char rssi_threshold_set;
    wlan_header_t wlan_hdr;
#if DUPLICATED_OCTET_PATCH
    unsigned short last_ap_seq;
    unsigned short last_ap_len;
    unsigned short dup_len[4];
#endif
} airkiss_control_t;
