...
EXTERN uint32_t gagent_task_stk[GAGENT_STACK_SIZE] __ALIGNED(8);
#endif

#ifdef CONFIG_GAGENT_TEST
EXTERN os_task_t gagent_task_tcb;
#endif

#define GAGENT_MAGIC_NUM    0x55aa1122
#define GAGENT_MAGIC_NUM_CONFIG    0x55aa1120
...
#define SOCKET_RECBUFFER_LEN (1*700)
...
//#define GAGENT_WIFI_RECONNECT_TIME (15*ONE_SECOND)
...
#define XPG_CFG_FLAG_CONNECTED      (1<<0) /* ��Ҫ��wifi����ģʽ��1=STA��0=AP */
#define XPG_CFG_FLAG_CHANGEPW       (1<<1) /* ��Ҫ�޸�passcode */
#define XPG_CFG_FLAG_CONFIG         (1<<2) /* ��Ҫ���Ƿ�ʹ��Onboarding����AirLink���ù� */
#define XPG_CFG_FLAG_CONFIGSUCCESS  (1<<3) /* ʹ���ⲿ���÷�ʽ�Ƿ�ɹ�����Ҫ���������ϵ����档ע���CONFIG������ */
#define CFG_FLAG_TESTMODE           (1<<4)
#define XPG_CFG_FLAG_CONFIG_AIRKISS (1<<5) /* ƽ̨������ʾ�Ƿ�airkiss���ù� ��Ҫ����airkiss���ð�*/
#define XPG_CFG_FLAG_CONFIG_AP      (1<<6) /* ��ʾ�Ƿ����softap������״̬ */
...
#define LOCAL_WIFI_LEVEL_MASK 0xF8FF
...
#define BUF_LEN 1024*2      /* depend on you platform ram size */
#define BUF_HEADLEN 128

#define AS xpg_assert(0) // ��ʾ����λ��
...
#define MS (GAgent_Printf(GAGENT_INFO, __FILE__ ":" _STR(__LINE__) ":" _STR(__FUNC__) "TOP Level Error:malloc")) // �ڴ�������
#define MBM ((void)0) // ��ǣ���Ҫע��ĵط�
