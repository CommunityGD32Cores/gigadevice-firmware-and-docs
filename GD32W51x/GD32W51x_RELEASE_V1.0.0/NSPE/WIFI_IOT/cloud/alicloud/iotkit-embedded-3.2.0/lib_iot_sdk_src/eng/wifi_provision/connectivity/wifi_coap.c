...
static const struct notify_map_t notify_map[] = {
    {AWSS_NOTIFY_DEV_RAND_SIGN,  METHOD_AWSS_DEV_INFO_NOTIFY,  TOPIC_AWSS_NOTIFY,           (void *)wifi_devinfo_notify_resp},
    {AWSS_NOTIFY_SUCCESS,        METHOD_AWSS_CONNECTAP_NOTIFY, TOPIC_AWSS_CONNECTAP_NOTIFY, (void *)wifi_suc_notify_resp}
};
...
int wifi_coap_common_register()
{
    ...
    wifi_coap_register(topic, (void *)wifi_process_ucast_get_connectap_info);
    wifi_coap_register(TOPIC_AWSS_GET_CONNECTAP_INFO_MCAST, (void *)wifi_process_mcast_get_connectap_info);
    return 0;
}
