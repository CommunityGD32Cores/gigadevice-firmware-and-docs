...
#undef MBEDTLS_ROM_TEST
#define MBEDTLS_ROM_TEST
...
const int ciphersuite_preference_default[] =
#else
...
#ifdef MBEDTLS_ROM_TEST
static int *ciphersuite_preference;
void mbedtls_ciphersuite_preference_init(int *array)
{
	if (array != NULL)
		ciphersuite_preference = array;
	else
		ciphersuite_preference = (int*)ciphersuite_preference_default;
}
#endif
...
#if defined(MBEDTLS_SSL_CIPHERSUITES) || defined(MBEDTLS_ROM_TEST)
