/*!
    \file  gd32f30x_eval.h
    \brief definitions for GD32F30X_EVAL's leds, keys and COM ports hardware resources
*/
...
#ifndef GD32F30X_EVAL_H
#define GD32F30X_EVAL_H
