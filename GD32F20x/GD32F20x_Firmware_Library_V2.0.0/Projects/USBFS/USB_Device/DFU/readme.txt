...
*/
  ...
  This demo is based on the GD32207i-EVAL board,it presents the implementation 
...
After each device reset, hold down the TAMPER key on the GD32F207I-EVAL board.
