...
*/
  ...
  This demo is based on the GD32207i-EVAL board, it shows TIMER peripheral to 
measure the frequency of an external signal.
  
  The TIMxCLK frequency is set to systemcoreclock,the prescaler is 6000 so 
the TIMER2 counter clock is 20KHz.
  ...
  The available frequence of the input signal is ranging from 0.03Hz to 20KHz.
