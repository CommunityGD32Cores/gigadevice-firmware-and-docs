...
*/
  ...
  This demo is based on the GD32207i-EVAL board, it shows how to configure the CAN 
...
will be printed and the LED1 will toggle.
  ...
  This example is tested with at least two GD32207i-EVAL boards. The same program example 
