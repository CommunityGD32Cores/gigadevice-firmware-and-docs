...
#ifndef USBD_CCID_CMD_H
#define USBD_CCID_CMD_H
...
/*
   ...
   an unimplemented slot, then the Slot Error register shall be set to (index of bSlot field).
 */
