...
usbd_status_enum printer_init (void *pudev, uint8_t config_index)
{
    ...
    usbd_ep_init(pudev, ENDP_SNG_BUF, &(configuration_descriptor.Printer_IN_Endpoint));

    /* initialize Rx endpoint */
    usbd_ep_init(pudev, ENDP_SNG_BUF, &(configuration_descriptor.Printer_OUT_Endpoint));
